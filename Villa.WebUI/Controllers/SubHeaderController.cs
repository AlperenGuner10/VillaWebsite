...
namespace Villa.WebUI.Controllers
{
	public class SubHeaderController : Controller
	{
		...
		public async Task<IActionResult> DeleteSubHeader(int id)
		{
		...
		public async Task<IActionResult> UpdateSubHeader(int id)
		{
			var values = await _subHeaderService.TGetByIdAsync(id);
			var updateValue = _mapper.Map<UpdateSubHeaderDto>(values);
